        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Password = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsBackofficeEmployee = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RentRequests_CompanyCustomers_CompanyCustomerId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentRequests_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentRequests_CompanyCustomerId",
                table: "RentRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentRequests_VehicleId",
                table: "RentRequests",
                column: "VehicleId");
        }
